...
class SourceTests(unittest.TestCase):
    ...
    def test_default_off_privileged_independent_gates(self):
        self.assertEqual(self.adapter.count('GucSetting::<bool>::new(false)'), 6)
        self.assertEqual(self.adapter.count('GucContext::Suset'), 6)
        ...
        self.assertIn('pin.enable_phrase_positions', self.adapter)
        self.assertIn('mutable::scan_query_with_options', self.adapter)

...
extern void pin_storage_check(Relation index, Relation heap, IndexInfo *info);
...
extern double pin_heap_build_scan(Relation heap, Relation index, IndexInfo *info,
...
extern void pin_index_cost(PlannerInfo *root, IndexPath *path, double loops,

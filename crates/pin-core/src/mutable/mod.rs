...
//! G2 has no owner-slot reuse, structural-page reclamation or background dependency.
...
/// Durable transition boundaries for fault injection in disposable test stores.
...
/// Resource cleanup belongs to the host's error/transaction machinery.
pub trait PageStore {

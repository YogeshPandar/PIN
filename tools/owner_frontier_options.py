"""Explicit per-connection activation for the dense owner frontier."""
from __future__ import annotations

NAME = 'pin.enable_owner_frontier'
...
def require_setting(actual: str | None, enabled: bool) -> str | None:
    # custom guc placeholders do not prove that the loaded binary implements the frontier.
